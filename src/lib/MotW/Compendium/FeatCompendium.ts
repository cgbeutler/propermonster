                    ...
                    options: [
                      {
                        ...
                        name: `Charm`,
                        abilityImprovement: {ability: Abilities.Charm, bonus: 1, max: 4},
                      },
                      {
                        id: `a9849b53-3e7c-4fe1-84fe-fb504c2bffe3`,
                        name: `Cool`,
                        abilityImprovement: {ability: Abilities.Cool, bonus: 1, max: 4},
                      },
                      {
                        id: `422b60c7-3f41-42f0-8177-d6e5e9b47440`,
                        name: `Sharp`,
                        abilityImprovement: {ability: Abilities.Sharp, bonus: 1, max: 4},
                      },
                      {
                        id: `9f142324-918a-43ec-a219-83df2269cf50`,
                        name: `Tough`,
                        abilityImprovement: {ability: Abilities.Tough, bonus: 1, max: 4},
                      },
                      {
                        id: `3393b93d-c718-40c2-a44d-134101cf4ae7`,
                        name: `Weird`,
                        abilityImprovement: {ability: Abilities.Weird, bonus: 1, max: 4},
                      },
                    ]
                  }]
                },
              ...
              options: [
                {
                  ...
                  passives: [{
                    type: PassiveTypes.Inventory,
                    description: `You sold your soul for wealth. You have only 1 year till your soul is forfeit.`,
                  }]
                },
                {
                  id: `1ed585f3-f6f2-4e21-8e89-0228feb53c76`,
                  ...
                  passives: [{
                    type: PassiveTypes.Social,
                    description: `You sold your soul for fame. You have only 1 year till your soul is forfeit.`,
                  }]
                },
                {
                  id: `ae1e108a-7328-464f-b43c-c8a14139c3e3`,
                  ...
                  passives: [{
                    type: PassiveTypes.Social,
                    description: `You sold your soul for youth. You have only 1 year till your soul is forfeit.`,
                  }]
                },
                {
                  id: `8189152a-6e65-40e5-896d-29ed45858eb3`,
                  ...
                  passives: [{
                    type: PassiveTypes.Social,
                    description: `You sold your soul for sexual gratification. You have only 1 year till your soul is forfeit.`,
                  }]
                },
                {
                  id: `ec0fdacc-0f6b-4b10-836f-3399a3b5decb`,
...
Unfortunately, you take the damage or illness upon yourself.`,
  ...
  },
  {
    ...
    modMoves: [{
      applyToMoves: [`bfdfd9b3-d5fa-4517-8d5e-20013364d7b0`], // Act Under Pressure
      alternateAbility: Abilities.Sharp,
    }]
  },
  {
    name: `Often Right`,
...
\`  @investigationQuestions\``, // TODO: Make the infiller indent when it finds whitespace
      }
    }]
  },
  {
  ...
  },
  {
    ...
    modMoves: [{
      applyToMoves: [`d245fc16-53f7-40bd-bdbb-45cde437adab`, `1d8097c8-90bc-485e-90a0-0eb9e94d0959`], // Manipulate Someone and Manipulate A Hunter
      alternateAbility: Abilities.Weird
    }]
  },
  {
...
You will find something important and useful, although not necessarily related to your immediate problems.`,
  ...
  },
  {
    ...
    modMoves: [{
      applyToMoves: [`48664b18-63e2-47fb-8363-ddcbefabe02e`], // Protect Someone
      alternateAbility: Abilities.Charm,
...
Take +1 Armor (max 2 armor) on top of whatever you get from your gear.`,
  ...
  },
  {
    ...
    modMoves: [{
      ...
      alternateAbility: Abilities.Cool,
    }]
  },
  {
    name: `Medic`,
...
Choose two good things and one bad thing about it (two good tags and one bad tag.)`,
    ...
    subFeatsById: [itemLookup.Professional.id],
  },
  {
...
• You hold the enemy back`,
  ...
  },
  {
    ...
    modMoves: [{
      applyToMoves: [`d245fc16-53f7-40bd-bdbb-45cde437adab`, `1d8097c8-90bc-485e-90a0-0eb9e94d0959`], // Manipulate Someone and Manipulate A Hunter
      alternateAbility: Abilities.Tough
    }]
  },
  {
    name: `Safety First`,
