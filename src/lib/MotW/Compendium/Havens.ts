...
export const havenLookup: Array<Feat> = [
  {
    ...
    perks: {
      modMoves: [{
        ...
        offset: 1,
        condition: `Apply once after you have spent time reading in your **Lore Library** about the relevant histories and references.`,
      }],
      haven: [{description: `Study the books here to take +1 \`forward\` to \`investigate the mystery\` (as long as historical or reference works are appropriate).`}]
    }
  },
  {
...
take +1 \`forward\` for \`use magic\` (or another **basic weird move**.)`,
    perks: {
      modMoves: [{
        name: `Mystical Library`,
        // TODO: Can we use this for others that are just: applyToMoves: [`ae7216e7-d5d0-4858-9469-9c3a04f47844`], // Use Magic  
        applyToMoves: [
        ...
        offset: 1,
        condition: `Apply once after you have spent time reading in your **Mystical Library**.`,
      }],
      haven: [{description: `If you use your library’s occult tomes and grimoires, preparing with your tomes and grimoires, take +1 \`forward\` for \`use magic\`.`}]
    }
  },
  {
    ...
    perks: {
      haven: [{description: `Monsters cannot enter your \`haven\` without doing something very special and difficult to evade the wards.`}]
    }
  },
  {
    name: `Armory`,
...
If you need a special weapon, you can search for it in your armory as a \`+Weird\` move.`,
      ...
      haven: [{description: `You have a stockpile of mystical and rare monster-killing weapons and items (see the "Search Armory" move.)`}]
    }
  },
  {
    name: `Infirmary`,
...
The Keeper will tell you how long any patient’s recovery is likely to take, and if you need extra supplies or help.`,
    perks: {
      health: [{description: `You can heal people, and have the space for one or two to recuperate.
The Keeper will tell you how long any patient’s recovery is likely to take, and if you need extra supplies or help.` }],
      haven: [{description: `You can heal people, and have the space for one or two to recuperate.
The Keeper will tell you how long any patient’s recovery is likely to take, and if you need extra supplies or help.`}]
    }
  },
  {
...
Work out with the Keeper how long any repair or construction will take, and if you need extra supplies or help.`
      ...
      haven: [{description: `You have a space for building and repairing guns, cars and other gadgets.
Work out with the Keeper how long any repair or construction will take, and if you need extra supplies or help.`}]
    }
  },
  {
...
This room is perfect for your burgeoning collection of creatures and artifacts.`,
    perks: {
      inventory: [{description: `Anything you stash in the oubliette can’t be found, can’t do any magic, and can’t get out.`}],
      haven: [{description: `This room is isolated from every kind of monster, spirit and magic that you know about.
Anything you stash in there can’t be found, can’t do any magic, and can’t get out.`}]
    }
  },
  {
...
You can hide out there for a few days, safe from pretty much anything.`,
    perks: {
      protections: [{description: `You can hide out in your **Panic Room** for a few days, safe from pretty much anything.`}],
      haven: [{description: `This has essential supplies and is protected by normal and mystical means.
You can hide out there for a few days, safe from pretty much anything.`}]
    }
  },
  {
...
\`use magic\`, \`big magic\`, and any other magical moves.`,
    perks: {
      allMoves: [{description: `You have a **Magical Laboratory** with all kinds of weird ingredients and tools to help with magic moves.`}],
      haven: [{description: `You have a mystical lab with all kinds of weird ingredients and tools to help with
\`use magic\`, \`big magic\`, and any other magical moves.`}]
    }
  },
  {
    ...
    perks: {
      haven: [{description: `You can develop film yourself here and manipulate it, such as zooming in, adding contrast, etc.`}]
    }
  },
] as const;
